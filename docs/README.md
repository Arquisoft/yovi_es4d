...
The deployment url is: [https://arquisoft.github.io/yovi_es4d/](https://arquisoft.github.io/yovi_es4d/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/yovi_es4d/](https://arquisoft.github.io/yovi_es4d/), we need to execute `npm run deploy`.
